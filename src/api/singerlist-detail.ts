...
export const getSingerDetailInfo = (id: string) => {
  return getAjax("/api/artists",{params:{id}})
};
/** 获取相似歌手信息 */
export const getSimSingerDetail = (id: string) => {
  return getAjax("/api/simi/artist",{params:{id}})
};
/** 获取歌手完整介绍 */
export const getSingerIntroduction = (id: string) => {
  return getAjax("/api/artist/desc",{params:{id}})
};
/** 获取歌手的MV作品 */
export const getSingerMV = (id: string,
  ...
  return getAjax("/api/artist/mv",{params:{id,limit,offset}})
};
/** 获取歌手的专辑详情 */
